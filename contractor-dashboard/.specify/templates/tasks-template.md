...
- [ ] T016 [US1] Add validation and explicit error handling with clear naming
- [ ] T017 [US1] Add intent-focused comments for non-obvious logic and edge cases
- [ ] T018 [US1] Document why any new files were created instead of extending existing files
...
- [ ] TXXX Readability pass for newcomer comprehension and naming clarity
- [ ] TXXX Ensure intent comments exist for non-obvious logic paths
- [ ] TXXX Verify new file creation is justified and documented
